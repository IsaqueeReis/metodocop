...
const INITIAL_SUBJECTS: Subject[] = [
  ...
  { id: '2', name: 'Matemática/Raciocínão Lógico', totalHoursStudied: 0 },
...
const INITIAL_MatériaLS: Material[] = [
  {
    id: 'm1',
...
export const getStorage = <T>(key: string, defaultValue: T): T => {
  ...
  if (!stored) {
    ...
    if (key === 'materials_global') return INITIAL_MatériaLS as unknown as T;
